...
from MatchAnything.SAM6D.SAM6D.Instance_Segmentation_Model.utils.inout import save_json, load_json, save_json_bop23
from MatchAnything.SAM6D.SAM6D.Instance_Segmentation_Model.model.utils import BatchedData, Detections, convert_npz_to_json
...
import trimesh
from MatchAnything.SAM6D.SAM6D.Instance_Segmentation_Model.model.loss import MaskedPatch_MatrixSimilarity
from MatchAnything.SAM6D.SAM6D.Instance_Segmentation_Model.utils.trimesh_utils import depth_image_to_pointcloud_translate_torch
from MatchAnything.SAM6D.SAM6D.Instance_Segmentation_Model.utils.poses.pose_utils import get_obj_poses_from_template_level
from MatchAnything.SAM6D.SAM6D.Instance_Segmentation_Model.utils.bbox_utils import xyxy_to_xywh, compute_iou
...
class Instance_Segmentation_Model(pl.LightningModule):
    ...
    def compute_appearance_score(self, best_pose, pred_objects_idx, qurey_appe_descriptors):
        ...
        print("ref_appe_descriptors: ", ref_appe_descriptors.shape)
