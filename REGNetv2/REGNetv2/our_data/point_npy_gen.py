...
src = "rgbd"
image_num = 4
rgb = cv2.imread(f'./{src}/{image_num}/color.png')[:, :, ::-1]  # BGR to RGB
depth = cv2.imread(f'./{src}/{image_num}/depth.png', cv2.IMREAD_UNCHANGED)  # depth should be uint16 or float
...
np.save(f"./{src}/{image_num}/pointcloud.npy", pc)
